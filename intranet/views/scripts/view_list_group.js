...
function init() {
    ...
    $('#ldgroup').addClass("kt-menu__item--active");
}
...
function listar() {
    ...
    t = $("#kt_table_1").DataTable({
        ...
        "ajax": {
            url: '../controllers/list.php?op=listar',
            data: { date_star: date_star, date_end: date_end, tipo_alumno: tipo_alumno, datos1: datos1, datos2: datos2 },
            type: "get",
            dataType: "json",
            error: function(e) {
