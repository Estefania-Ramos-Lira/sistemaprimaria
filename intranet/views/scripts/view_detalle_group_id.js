...
function init(){
    ...
    $('#lgroupid').addClass("kt-menu__item--active");
} 
...
function viewpdf()
{
    ...
    var datos2 = $("#datos2").val();
     ...
     $("#view_pdf").html('<embed src="../reports/rpt_identification_group.php?&date_star='+date_star+'&date_end='+date_end+'&tipo_alumno='+tipo_alumno+'&datos1='+datos1+'&datos2='+datos2+'&timeingreso='+timeingreso+'" type="application/pdf" width="100%" height="100%"></embed>');
     }
}
