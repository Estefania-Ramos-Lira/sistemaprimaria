...
$spreadsheet->getActiveSheet()->mergeCells("B1:J1"); // FONDO AMARILLO DEL ENCABEZADO 
$spreadsheet->getActiveSheet()->mergeCells("B2:J2"); //FONDO AMARILLO DEL ENCABEZADO
...
$spreadsheet->getActiveSheet()->duplicateStyle($sharedStyle2, 'B1:J2'); // LINEAS EN ENCUADRE DEL ENCABEZADO
$spreadsheet->getActiveSheet()->duplicateStyle($sharedStyle4, 'B3:J3'); // LINEAS EN ENCUADRE DEL ENCABEZADO
...
$spreadsheet->getActiveSheet()->mergeCells("A5:E5"); // TABLA
...
$spreadsheet->getActiveSheet()->setCellValue('A5', "DATOS DE LOS ALUMNOS");
